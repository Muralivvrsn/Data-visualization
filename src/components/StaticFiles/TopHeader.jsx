  ...
  return (
    <div className='topHeader fixed w-8/12 p-16'>
     ...
     <div className="psection flex absolute w-2/4 bg-white-500 rounded-full pr-8 items-center top-2/4 h-3/4 left-3/4">
      ...
      <div class="flex items-center w-3/4 pl-4 bg-transparent">   
          <div class="relative w-full bg-transparent">
              <div class="absolute bg-transparent inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                  <svg aria-hidden="true" class="w-5 h-5 text-gray-500 bg-transparent dark:text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M8 4a4 4 0 100 8 4 4 0 000-8zM2 8a6 6 0 1110.89 3.476l4.817 4.817a1 1 0 01-1.414 1.414l-4.816-4.816A6 6 0 012 8z" clip-rule="evenodd"></path></svg>
              </div>
              <input type="text" id="simple-search" class="rounded-full  bg-gray-50 border border-gray-300 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full h-11/12 pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search" required/>
          </div>
      </div>
